...
if ($user->guest) {
    ?>
    <a class="add_wishlist hasTooltip <?php if (is_array($_SESSION['wishlist_ids']) && in_array($this->product2->virtuemart_product_id, $_SESSION['wishlist_ids'])) {
        echo 'go_to_whishlist active';
    } ?>" title="<?php echo JText::_('ADD_TO_WHISHLIST'); ?>"
       onclick="addToWishlists('<?php echo $this->product2->virtuemart_product_id; ?>');"><i
            class="fa fa-heart-o"></i><span><?php echo JText::_("ADD_TO_WHISHLIST"); ?></span></a>
<?php
} else {
    ...
    ?>
    <a class="add_wishlist hasTooltip <?php if (in_array($this->product2->virtuemart_product_id, $allprod['id'])) {
        echo 'go_to_whishlist active';
    } ?>" title="<?php echo JText::_('ADD_TO_WHISHLIST'); ?>"
       onclick="addToWishlists('<?php echo $this->product2->virtuemart_product_id; ?>');"><i
            class="fa fa-heart-o"></i><span><?php echo JText::_("ADD_TO_WHISHLIST"); ?></span></a>
