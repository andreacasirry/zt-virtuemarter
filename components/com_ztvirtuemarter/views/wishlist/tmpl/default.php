            ...
            foreach ($this->products as $product) :
                ...
                <div class="wrapper-slide">
                    ...
                    <?php if (!empty($show_price)) :
                        ...
                        <div class="addtocart-area2">
                            ...
                            <span class="addtocart_button2">
                                <a class="addtocart-button" title="<?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?>" href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=productdetails&layout=notify&virtuemart_product_id=' . $product->virtuemart_product_id); ?>"><?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?>
                                    <span></span>
                                </a>
                            </span>
                            <?php  else : ?>
                    ...
                    <div class="remwishlists">
                        <a class="wishlist_del" title="remove" onclick="removeWishlists('<?php echo $product->virtuemart_product_id; ?>');">
