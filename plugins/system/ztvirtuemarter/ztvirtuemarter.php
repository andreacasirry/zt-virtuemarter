                        ...
                        <div class="fleft">
                            <div class="image_show_quick">
                                ...
                                if (!empty($product->images[0])) {
                                    ?>
                                    <img style="display:none!important;" src="<?php echo $mainImageUrl ?>" class="big_img" id="Img_to_Js_<?php echo $vm_id ?>"/>
                                    <div class="main-image-quick">
                                        ...
                                        <img src="<?php echo $mainImageUrl ?>" data-zoom-image="<?php echo $mainImageUrl ?>" title="<?php echo $main_image_title ?>" alt="<?php echo $main_image_alt ?>" class="big_img" id="Img_zoom"/>
                                            ...
                                            <div id="gallery_01" class="additional-images <?php echo $class; ?>">
                                                <ul id="carousel" class=" quickview_carousel paginat jcarousel-skin-tango">
                                                    ...
                                                    for ($i = 0; $i < $j; $i++) {
                                                        ?>
                                                        <li class="floatleft">
                                                            <a href="#" data-image="<?php echo JURI::root() . '' . $images[$i]->file_url; ?>" data-zoom-image="<?php echo JURI::root() . '' . $images[$i]->file_url; ?>">
                            ...
                            <?php if ((!empty($product->prices['salesPrice'])) && !$product->images[0]->file_is_downloadable) { ?>
                                ...
                                if ($product->prices['salesPrice'] <= 0 and VmConfig::get('askprice', 1)) {
                                    ...
                                    <div class="call-a-question">
                                        <a class="call modal" rel="{handler: 'iframe', size: {x: 460, y: 550}}" href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=productdetails&task=askquestion&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' . $product->virtuemart_category_id . '&tmpl=component'); ?>">
                                        ...
                                        <form method="post" class="product js-recalculate" action="<?php echo JURI::getInstance()->toString(); ?>">
                                            ...
                                            <div class="addtocart-bar2">
                                                ...
                                                if (($stockhandle == 'disableit' or $stockhandle == 'disableadd') and ($product->product_in_stock - $product->product_ordered) < 1) { ?>
                                                    <a class="addtocart-button hasTooltip" title="<?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?>" href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=productdetails&layout=notify&virtuemart_product_id=' . $product->virtuemart_product_id); ?>"><?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?>
                                                        <span></span>
                                                    </a>
                                                <?php } else { ?>
                                                    <div class="wrapper">
                                                        ...
                                                        <?php if ($product->orderable) { ?>
                                                            <button type="submit" value="<?php echo vmText::_ ('COM_VIRTUEMART_CART_ADD_TO'); ?>" title="<?php echo JText::_('COM_VIRTUEMART_CART_ADD_TO'); ?>" class="addtocart-button cart-click"><?php echo JText::_('COM_VIRTUEMART_CART_ADD_TO'); ?>
                                                                <span>&nbsp;</span>
                                                            </button>
                                                        <?php } else { ?>
