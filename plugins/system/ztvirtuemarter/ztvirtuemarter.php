    ...
    public function onAfterInitialise()
    {
        ...
        if ($region) {
            ...
            <script type="text/javascript"
                    src="<?php echo JUri::root(); ?>/plugins/system/ztvirtuemarter/assets/js/more_custom.js"></script>
            <script type="text/javascript"
                    src="<?php echo JUri::root(); ?>/plugins/system/ztvirtuemarter/assets/js/shortcodes.js"></script>
            <div class="wrapper2">
            <div class="fleft">
                                ...
                                <div id="gallery_01" class="additional-images <?php echo $class; ?>">
                                    <ul id="carousel" class=" quickview_carousel paginat jcarousel-skin-tango">
                                        ...
                                        for ($i = 0; $i < $j; $i++) {
                                            ...
                                            <li class="floatleft">
                                                <a href="#"
                                                   data-image="<?php echo JURI::root() . '' . $images[$i]->file_url; ?>"
                                                   data-zoom-image="<?php echo JURI::root() . '' . $images[$i]->file_url; ?>">
                                                    <img
                                                        src="<?php echo JURI::root() . '' . $images[$i]->file_url_thumb; ?>"/>
                                                </a>
                                            </li>
                                        <?php
                                        }
