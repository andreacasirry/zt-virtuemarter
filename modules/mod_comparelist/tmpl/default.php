...
<div class="vmgroup<?php echo $params->get('moduleclass_sfx') ?>" id="mod_compare">
    ...
    <div class="seldcomp" id="butseldcomp">
        <a class="btn_compare" href="<?php echo JRoute::_('index.php?option=com_virtuemartzooex&view=comparelist&Itemid=' . $itemid . ''); ?>">
            <i class="fa fa-files-o"></i><?php echo JText::_('COM_COMPARE_GO'); ?>
        </a>
    </div>
</div>
